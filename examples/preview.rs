...
fn main() {
    ...
    // 6. accessory sheet: all 9 accessories on the cat, for visual review.
    {
        let all = [
            Accessory::Scarf,
            Accessory::Glasses,
    ...
    // 7. shipped collection: every unlockable accessory, rendered via from_id
