...
| [0009](0009-release-tag-version-mismatch.md) | Auto-update looped forever: release tag built from an un-bumped Cargo.toml, so the new binary still reported the old version | release process + auto-update |
