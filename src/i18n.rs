...
pub fn t(lang: Lang, msg: Msg) -> &'static str {
    ...
    match (msg, lang) {
        ...
        (FooterKeys, Lang::En) => "ENTER COPY | DEL DELETE | ^Z UNDO | ^P PIN | TAB APP",
        (FooterKeys, Lang::Ko) => "Enter 복사 | Del 삭제 | ^Z 복구 | ^P 고정 | Tab 앱별",
...
mod tests {
    ...
    fn every_message_has_both_translations() {
        ...
        let all = [
            ...
            ToastCopied, ToastDeleted, ToastRestored, ToastClearConfirm,
